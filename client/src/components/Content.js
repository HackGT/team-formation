        ...
        this.onFetchLogin().then(() => {
            ...
            if (login_json.email) {
                ...
                if(!login_json.slackid) {
                    window.location.replace("https://slack.com/oauth/v2/authorize?user_scope=identity.basic,identity.email,identity.team&client_id=15533117780.599676767764&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fapi%2Fuser%2Fslack%2Fcallback")
                }
