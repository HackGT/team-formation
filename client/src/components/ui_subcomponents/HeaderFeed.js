...
class Headers extends Component {
    ...
    render() {
        ...
        return (<QueryRenderer environment={environment} query={getName} variables={{}} render={({error, props}) => {
                if (error) {
                        ...
                        <Menu borderless="borderless" size={"massive"}>
                            ...
                            <Menu.Menu borderless="borderless" position="right" size={"massive"}>
                                ...
                                <Dropdown item="item" icon="bell" direction="left" closeOnChange={false}>
                                    <Dropdown.Menu className="notification-pane compact" style={{
                                            maxWidth: 300
                                        }}>
                                        <NotificationGroup onTeamPageClick={this.props.onTeamPageClick}/>
                                    </Dropdown.Menu>
                                </Dropdown>
