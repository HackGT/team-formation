                    ...
                    <div className="team-card-container">
                        <Card fluid="fluid">
                            <Card.Content className="card-content">
                                ...
                                <Form className="form">
                                    <Form.Field className='input' control={TextArea} label='Team Bio' value={this.state.teamBio} style={{
                                            minHeight: 150,
                                            resize: 'none'
                                        }} disabled="disabled"/>
                                    <Form.Field className='input' control={TextArea} label='Project Idea' value={this.state.projectIdea} style={{
                                            minHeight: 150,
                                            resize: 'none'
                                        }} disabled="disabled"/>
                                </Form>
                        ...
                        <Card fluid="fluid">
                            <Card.Content className="card-content">
                                ...
                                <Form className="form" success>
                                    <Form.Field defaultValue={this.state.teamBio} onChange={this.onTeamBioChange} control={TextArea} className='input' label='Team Bio' placeholder='Tell us about your team'/>
                                    <Form.Field defaultValue={this.state.projectIdea} onChange={this.onProjectIdeaChange} className='input' control={TextArea} label='Project Idea' placeholder='Describe any ideas you have for a potential project'/>
                                    <Form.Dropdown defaultValue={this.state.interests} label='Interests' options={this.state.interest_options} placeholder='Select Interests' search="search" selection="selection" fluid="fluid" multiple="multiple" allowAdditions="allowAdditions" onAddItem={this.handleAddition} onChange={this.handleChange}/>
