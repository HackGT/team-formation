          ...
          if (props.user_profile.team == null) {
            teamIcon = (
              <Popup
                hoverable={false}
                trigger={
                  <Icon name="group" size="large" inverted link={true} />
                }
            ...
            teamIcon = (
              <Popup
                trigger={
                  <Link to={link}>
                    <Icon name="group" link={true} size="large" inverted />
                  </Link>
                }
              ...
              <Menu secondary borderless="borderless" size={"massive"}>
                <Menu.Menu position="right">
                  <Menu.Item>
                    ...
                    >
                      {props.user_profile.team
                        ? `${props.user_profile.name} (${truncateTeamName(
                            props.user_profile.team.name
                          )})`
                        : props.user_profile.name}
                    </Flex>
                  </Menu.Item>
                  <Menu.Item
                    style={{
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        display: "inline",
                        fontFamily:
                          "Futura, futura-pt, Trebuchet MS, sans-serif",
                        fontSize: "32px",
                        color: "white",
                        ml: "35px",
                      }}
