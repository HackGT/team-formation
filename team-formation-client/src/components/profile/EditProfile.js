    ...
    if (this.state.contact_method === "phone number") {
      contact_form = (
        <Form.Input
          ...
          error={this.state["contact_profane"]}
          required="required"
        />
      );
                ...
                <Form className="form-container">
                  ...
                  <Form.Group className="school-and-year">
                    <Form.Select
                      ...
                      error={this.state["school_profane"]}
                      options={schools}
                      required="required"
                    />
                    <Form.Select
                  ...
                  <Form.Group>{this.state.cur_error_message}</Form.Group>
                </Form>
              </div>
            );
          }
    ...
    if (
      ...
      cur_error = (
        <Message>
          ...
          <p>Please review your profile for profane language and try again</p>
        </Message>
      );
      this.setState({ cur_error_message: cur_error });
    } else {
